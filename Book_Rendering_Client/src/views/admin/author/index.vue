        ...
        <div class="flex" style="height: 500px;">
            <div class="w-8/12  h-full  border-r-2 border-slate-300">
                ...
                <div v-if="message == 'created'" class="flex justify-between p-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                    ...
                    <div>
                        <span class="font-medium">Author</span> {{ this.message }} successfully.
                    </div>
                    ...
                    <div class="bg-white border-slate-300 border-2 rounded-xl px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="username" type="text" placeholder="Create a author name" v-model="formData.name">
                        </div>
...
export default {
    ...
    methods: {
        remove(index){
            ...
            ApiServices.delete('authors/'+ id).then(response => {
        ...
        formSubmit() {
            this.pageLoading = true;
            ApiServices.post('authors', this.formData ).then(response => {
                this.rows = response.data.data.data;
                this.total = response.data.data.total;
                this.from = response.data.data.from;
                this.to = response.data.data.to;
        ...
        edit(){
            ApiServices.patch('authors/'+ this.showData.id, this.formData ).then(response => {
                this.rows = response.data.data.data;
                this.total = response.data.data.total;
                this.from = response.data.data.from;
                this.to = response.data.data.to;
